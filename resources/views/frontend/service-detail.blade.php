                                ...
                                <section>
                                    <div class="position-relative w-100">
                                        <div
                                            ...
                                            <h3 class="mb-0 fw-normal sz-36">Brand Identity Design</h3>
                                            <ol class="breadcrumb mb-0">
                                                <li class="breadcrumb-item"><a href="index.html" title="">Home</a></li>
                                                <li class="breadcrumb-item active">Brand Identity Design</li>
                                            </ol>
                                        </div><!-- Page Title -->
                                    </div>
                                </section>
                                <section>
                                    <div class="position-relative pt-60 w-100">
                                        <div class="serv-detail position-relative w-100">
                                            <div
                                                class="serv-detail-img round15 overflow-hidden position-relative w-100">
                                                <img class="img-fluid w-100"
                                                    src="assets/images/resources/serv-detail-img1.jpg"
                                                    alt="Service Detail Image" loading="lazy">
                                            ...
                                            <div class="serv-detail-cont mt-50 position-relative w-100">
                                                <div class="serv-detail-cap position-relative w-100">
                                                    <span>Fashion & Beauty, Blue</span>
                                                    <h3 class="mb-0 fw-normal sz-36">Brand Identity Design <strong>24
                                                            Projects</strong></h3>
                                                    <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing
                                                        elit. In nisi, augue urna, mauris elementum ligula semper enim.
                                                    ...
                                                    <p class="mb-0">Srepellat volup tatibus maiores aliasta consequatur
                                                        auto perferendis repellat quia voluptas sit upto aspernatur te
                                                        natus
                                                        accusan. Professional translation scaled by experts Donec
                                                        imperdiet risus at tortor consequat maximus et eget magna.
                                                        Cras ornare sagittis augue, id sollicitudin justo tristique ut.
                                                    </p>
                                                    <p class="mb-0">Donec imperdiet risus at tortor consequat. Cras
                                                        ornare sagittis augue, id sollicitudin justo tristique ut.
                                                        Nullam ex
                                                        enim, euismod vel bibendum ultrices. Developing core
                                                        applications sit amet, consectetur.</p>
                                                ...
                                                <div
                                                    ...
                                                    <div class="sec-title d-flex flex-column align-items-start">
                                                        ...
                                                        <p class="mb-0">Let’s start to capture the wonderful moments of
                                                            your
                                                            life.
                                                        </p>
                                                    </div><!-- Sec Title -->
                                                ...
                                                <div
                                                    class="serv-detail-cont-box d-inline-block position-relative w-100">
                                                    <div class="row align-items-start">
                                                        <div class="col-md-5 col-sm-12 col-lg-4 order-md-1">
                                                            <div
                                                                ...
                                                                <a href="assets/images/resources/serv-detail-img2.jpg"
                                                                    data-fancybox="gallery" title=""><img
                                                                        class="img-fluid w-100"
                                                                        src="assets/images/resources/serv-detail-img2.jpg"
                                                                        alt="Service Detail Image" loading="lazy"></a>
                                                            </div><!-- Single Gallery Box -->
                                                        </div>
                                                        <div class="col-md-7 col-sm-12 col-lg-8">
                                                            <h3 class="mb-0 fw-normal sz-36">How To Deal With Employee
                                                                Quitting</h3>
                                                            <p class="mb-0">Vestibulum et pharetra arcu. In porta
                                                                lobortis
                                                                turpis. Ut faucibus fermentum posuere. Suspendisse
                                                                potenti.
                                                                Mauris a
                                                                metus sed est semper vestibulum.</p>
                                                            <ul class="list-style d-flex flex-column mb-0">
                                                                ...
                                                                <li>Knowledge of industry standard security concepts and
                                                                    protocols.</li>
                                                                <li>Advanced degree in Computer Science or related
                                                                    degree.
                                                                </li>
                                                ...
                                                <p class="mb-0">At vero eos et accusamus etodio dignissimos ducimus
                                                    ...
                                                    mollitia animi, id est laborum et dolorum</p>
                                                <div
                                                    class="tags-box-wrap round15 d-flex align-items-center justify-content-between position-relative w-100">
                                                    <div class="tags-box d-flex align-items-center position-relative">
                                                        <span>Tags:</span>
                                                        <div class="tagcloud d-flex align-items-center gap-1">
                                                            <a href="javascript:void(0);" title="">figma</a>
                                                            <a href="javascript:void(0);" title="">webflow</a>
                                                            <a href="javascript:void(0);" title="">Career</a>
                                                        </div><!-- Tagcloud -->
                                                    </div><!-- Tags Box -->
                                                    <div
                                                        class="single-social-wrap d-flex align-items-center position-relative">
                                                        <span>Share:</span>
                                                ...
                                                <div class="single-detail-navs d-flex align-items-center w-100">
                                                    <div
                                                        class="single-detail-nav-item single-detail-nav-left d-flex flex-column position-relative">
                                                    ...
                                                    <div
                                                        class="single-detail-nav-item single-detail-nav-right d-flex flex-column position-relative">
                                                        <a href="javascript:void(0);" title="">
                                                            <strong>Next</strong>

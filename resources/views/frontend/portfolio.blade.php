                            ...
                            <section>
                                <div class="position-relative w-100">
                                    <div
                                        ...
                                        <h3 class="mb-0 fw-normal sz-36">My Recent Projects</h3>
                            ...
                            <section>
                                <div class="position-relative pt-60 w-100">
                                    <div class="port-boxes position-relative w-100">
                                        <div class="row mrg20">
                                            <div class="col-md-6 col-sm-6 col-lg-4 wow fadeIn" data-wow-duration=".8s"
                                                data-wow-delay=".2s">
                                                <div class="port-box d-flex flex-column align-items-start w-100">
                                                    ...
                                                    <div class="port-info d-flex flex-column align-items-start w-100">
                                                        <a class="port-read rounded-circle" href="portfolio-detail.html"
                                                            title=""><i class="far fa-long-arrow-right"></i></a>
                                                        <h4 class="mb-0 fw-normal sz-26"><a href="portfolio-detail.html"
                                                                title="">Minimal
                                                                Magazine</a></h4>
                                                        <span>Designing</span>
                                                    </div><!-- Portfolio Info -->
                                            ...
                                            <div class="col-md-6 col-sm-6 col-lg-4 wow fadeIn" data-wow-duration=".8s"
                                                ...
                                                <div class="port-box d-flex flex-column align-items-start w-100">
                                                    <div class="port-img round15 overflow-hidden position-relative w-100">
                                                        <a href="portfolio-detail.html" title=""><img
                                                                class="img-fluid w-100"
                                                                src="assets/images/resources/port-img2.jpg"
                                                                alt="Portfolio Image" loading="lazy"></a>
                                                        <div class="port-cat d-flex align-items-center position-absolute">
                                                            <a href="javascript:void(0);" title="">Adobe
                                                                XD</a><a href="javascript:void(0);" title="">UI/UX
                                                                Design</a>
                                                        </div><!-- Portfolio Categories -->
                                                    </div><!-- Portfolio Image -->
                                                    <div class="port-info d-flex flex-column align-items-start w-100">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-lg-4 wow fadeIn" data-wow-duration=".8s"
                                                ...
                                                <div class="port-box d-flex flex-column align-items-start w-100">
                                                    <div class="port-img round15 overflow-hidden position-relative w-100">
                                                        <a href="portfolio-detail.html" title=""><img
                                                                class="img-fluid w-100"
                                                                src="assets/images/resources/port-img3.jpg"
                                                                alt="Portfolio Image" loading="lazy"></a>
                                                        <div class="port-cat d-flex align-items-center position-absolute">
                                                            <a href="javascript:void(0);" title="">WordPress</a><a
                                            ...
                                            <div class="col-md-6 col-sm-6 col-lg-4 wow fadeIn" data-wow-duration=".8s"
                                                ...
                                                <div class="port-box d-flex flex-column align-items-start w-100">
                                                    <div class="port-img round15 overflow-hidden position-relative w-100">
                                                        <a href="portfolio-detail.html" title=""><img
                                                                class="img-fluid w-100"
                                                                src="assets/images/resources/port-img4.jpg"
                                                                alt="Portfolio Image" loading="lazy"></a>
                                                        <div class="port-cat d-flex align-items-center position-absolute">
                                                            <a href="javascript:void(0);" title="">figma</a><a
                                                                href="javascript:void(0);" title="">Experimental</a>
                                                        </div><!-- Portfolio Categories -->
                                                    </div><!-- Portfolio Image -->
                                                    <div class="port-info d-flex flex-column align-items-start w-100">
                                                        <a class="port-read rounded-circle" href="portfolio-detail.html"
                                            ...
                                            <div class="col-md-6 col-sm-6 col-lg-4 wow fadeIn" data-wow-duration=".8s"
                                                ...
                                                <div class="port-box d-flex flex-column align-items-start w-100">
                                                    <div class="port-img round15 overflow-hidden position-relative w-100">
                                                        <a href="portfolio-detail.html" title=""><img
                                                                class="img-fluid w-100"
                                                                src="assets/images/resources/port-img5.jpg"
                                                                alt="Portfolio Image" loading="lazy"></a>
                                                        <div class="port-cat d-flex align-items-center position-absolute">
                                                            <a href="javascript:void(0);" title="">Adobe XD</a><a
                                                                href="javascript:void(0);" title="">Food & Drink</a>
                                                        </div><!-- Portfolio Categories -->
                                                    </div><!-- Portfolio Image -->
                                                    <div class="port-info d-flex flex-column align-items-start w-100">
                                                        <a class="port-read rounded-circle" href="portfolio-detail.html"
                                            ...
                                            <div class="col-md-6 col-sm-6 col-lg-4 wow fadeIn" data-wow-duration=".8s"
                                                ...
                                                <div class="port-box d-flex flex-column align-items-start w-100">
                                                    <div class="port-img round15 overflow-hidden position-relative w-100">
                                                        <a href="portfolio-detail.html" title=""><img
                                                                class="img-fluid w-100"
                                                                src="assets/images/resources/port-img6.jpg"
                                                                alt="Portfolio Image" loading="lazy"></a>
                                                        <div class="port-cat d-flex align-items-center position-absolute">
                                                            <a href="javascript:void(0);" title="">editorial</a><a
                                                                href="javascript:void(0);" title="">blue</a>
                                                        </div><!-- Portfolio Categories -->
                                                    </div><!-- Portfolio Image -->
                                                    <div class="port-info d-flex flex-column align-items-start w-100">
                                                        <a class="port-read rounded-circle" href="portfolio-detail.html"
                                            ...
                                            <div class="col-md-6 col-sm-6 col-lg-4 wow fadeIn" data-wow-duration=".8s"
                                                ...
                                                <div class="port-box d-flex flex-column align-items-start w-100">
                                                    <div class="port-img round15 overflow-hidden position-relative w-100">
                                                        <a href="portfolio-detail.html" title=""><img
                                                                class="img-fluid w-100"
                                                                src="assets/images/resources/port-img7.jpg"
                                                                alt="Portfolio Image" loading="lazy"></a>
                                                        <div class="port-cat d-flex align-items-center position-absolute">
                                                            <a href="javascript:void(0);" title="">figma</a><a
                                                                href="javascript:void(0);" title="">Business &
                                                                Work</a>
                                                        </div><!-- Portfolio Categories -->
                                                    </div><!-- Portfolio Image -->
                                                    <div class="port-info d-flex flex-column align-items-start w-100">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-lg-4 wow fadeIn" data-wow-duration=".8s"
                                                ...
                                                <div class="port-box d-flex flex-column align-items-start w-100">
                                                    <div class="port-img round15 overflow-hidden position-relative w-100">
                                                        <a href="portfolio-detail.html" title=""><img
                                                                class="img-fluid w-100"
                                                                src="assets/images/resources/port-img8.jpg"
                                                                alt="Portfolio Image" loading="lazy"></a>
                                                        <div class="port-cat d-flex align-items-center position-absolute">
                                                            <a href="javascript:void(0);" title="">Adobe XD</a><a
                                                                href="javascript:void(0);" title="">Experimental</a>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-lg-4 wow fadeIn" data-wow-duration=".8s"
                                                ...
                                                <div class="port-box d-flex flex-column align-items-start w-100">
                                                    <div class="port-img round15 overflow-hidden position-relative w-100">
                                                        <a href="portfolio-detail.html" title=""><img
                                                                class="img-fluid w-100"
                                                                src="assets/images/resources/port-img9.jpg"
                                                                alt="Portfolio Image" loading="lazy"></a>
                                                        <div class="port-cat d-flex align-items-center position-absolute">
                                                            <a href="javascript:void(0);" title="">editorial</a><a
                                                                href="javascript:void(0);" title="">blue</a>
                                    ...
                                    <div class="load-more mt-70 d-block position-relative w-100">
                                        <a class="load-more-btn d-flex align-items-center justify-content-center overflow-hidden round15 position-relative text-center w-100"
                                            href="javascript:void(0);" title="">Load More</a>
                                    </div><!-- Load More -->
                                </div>
                            </section>
                            <section>

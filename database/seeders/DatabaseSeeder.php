...
/* -----------------------------------------------------------------
        ...
        foreach ([
            'project_technology','project_tag','blog_tag',  // pivots first
            'service_images','project_images','project_videos',
            'contacts','social_links','site_settings',
            'skills','education','experiences','testimonials',
            'certificates','faqs',
            'projects','services','blogs',
        ...
        foreach ($technologies as $t) {
            DB::table('technologies')->insert([
                'name_en'=>$t[0],'name_ar'=>$t[1],'logo'=>"logos/$t[2]",
                'created_at'=>$now,'updated_at'=>$now,
            ]);
        }
        ...
        foreach ($servicesData as $i=>$s) {
            DB::table('services')->insert([
                'slug'=>$s[0], 'title_en'=>$s[1], 'title_ar'=>$s[2],
                'description_en'=>"$s[1] service description.",
                'description_ar'=>"وصف خدمة $s[2].",
                'price'=>$s[3], 'currency'=>$s[4],
                'unit_en'=>$s[5], 'unit_ar'=>'لكل وحدة',
        ...
        foreach ($projectSlugs as $idx=>$slug) {
            ...
            DB::table('projects')->insert([
                ...
                'duration_en'=>'2-4 months','duration_ar'=>'٢-٤ أشهر',
         ...
         */
        $skills = [
            ['React.js',1],['Vue.js',1],['Laravel',1],['Django',1],
            ['Docker',4],['Kubernetes',4],['AWS',4],['Figma',5],
            ['TailwindCSS',1],['MySQL',1],['PostgreSQL',1],['Redis',1],
        ];
        foreach ($skills as $s) {
        ...
        DB::table('testimonials')->insert([
            [
                'name'=>'Reem Al-Hussein','role'=>'Project Manager','rating'=>5,
                'message_en'=>'Delivered ahead of schedule!','message_ar'=>'تم التسليم قبل الموعد!',
                'image'=>'testimonials/reem.jpg','date_given'=>'2025-02-15',
                'created_at'=>$now,'updated_at'=>$now,
            ],
            [
                'name'=>'Ahmad Al-Zoubi','role'=>'CTO','rating'=>4,
                'message_en'=>'Great eye for detail.','message_ar'=>'دقة عالية في التفاصيل.',
                'image'=>'testimonials/ahmad.jpg','date_given'=>'2024-09-10',
                'created_at'=>$now,'updated_at'=>$now,
            ],
        ]);
        ...
        DB::table('contacts')->insert([
            [
                ...
                'subject'=>'Inquiry','message'=>'Loved your recent project!',
                'created_at'=>$now,'updated_at'=>$now,
            ],
            [
                'name'=>'Sarah','email'=>'sarah@example.com',
                'subject'=>'Quote','message'=>'Need an e-commerce site.',
                'created_at'=>$now,'updated_at'=>$now,
            ],
        ]);
